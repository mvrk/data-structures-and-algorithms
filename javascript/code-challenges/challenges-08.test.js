...
regular expression pattern to return true if the input contains a number,
...
should use a regular expression pattern to return true if the input contains the word 'world'
