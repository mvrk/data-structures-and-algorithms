...
const toLastNames = people => {
  return people.map(objects => `${objects.firstName} ${objects.lastName}`);
};
...
const returnNames = (starWarsData) => {
  return starWarsData.reduce((previousValue, currentValue) => previousValue.concat(currentValue.name), []);
};
